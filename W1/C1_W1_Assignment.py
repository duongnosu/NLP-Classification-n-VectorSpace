...
# # Assignment 1: Logistic Regression - Nhu Duong
# Implementing logistic regression for sentiment analysis on tweets. Given a tweet, you will decide if it has a positive sentiment or a negative one. Specifically you will:
#
...
def test_logistic_regression(test_x, test_y, freqs, theta):
    ...
    accuracy = np.sum(((np.asanyarray(y_hat) == np.squeeze(test_y)) / len(test_y)))
...
my_test_tweet = 'Where is my DutchBros?'
y_hat = predict_tweet(my_test_tweet, freqs, theta)
print(y_hat)
if y_hat > 0.5:
    print('Positive sentiment')
else:
